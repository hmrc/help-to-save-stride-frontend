...
package uk.gov.hmrc.helptosavestridefrontend.http
...
object HttpClient {
  ...
  implicit class HttpClientOps(val http: uk.gov.hmrc.play.bootstrap.http.HttpClient) extends AnyVal {
    ...
    def delete[A](url: String)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[HttpResponse] =
      http.DELETE(url)(rawHttpReads, hc, ec)
  }
