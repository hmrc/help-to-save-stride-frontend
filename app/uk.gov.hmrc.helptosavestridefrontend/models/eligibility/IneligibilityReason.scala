...
import cats.Eq
import uk.gov.hmrc.helptosavestridefrontend.controllers.SessionBehaviour.EligibilityCheckResultWithInfo.Ineligible
...
object IneligibilityReason {
  ...
  def fromIneligible(ineligible: Ineligible): Option[IneligibilityReason] = ineligible.response.reasonCode match {
