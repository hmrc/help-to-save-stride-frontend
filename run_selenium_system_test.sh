 ...
 case $PARAM in
   ...
   then
     ...
     exit 1
       ...
       ;;
   --browser | -b)
   if [ "$VALUE" != 'chrome' ] && "$VALUE" != 'chrome' ] && [ "$VALUE" != 'firefox' ] && [ "$VALUE" != 'zap-chrome' ] && [ "$VALUE" != 'headless' ] && [ "$VALUE" != 'browserstack' ] && [ "$VALUE" != 'browserstack1' ] && [ "$VALUE" != 'browserstack2' ] && [ "$VALUE" != 'browserstack3' ] && [ "$VALUE" != 'browserstack4' ]
   then
        usage
        exit 1
   fi
