...
object AllowManualAccountCreationPage extends Page {

  override val expectedURL = s"${Configuration.host}/help-to-save/hmrc-internal/allow-manual-account-creation"
