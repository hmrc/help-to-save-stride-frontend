...
import uk.gov.hmrc.helptosavestridefrontend.models.eligibility.EligibilityCheckResult.Ineligible
import uk.gov.hmrc.helptosavestridefrontend.models.eligibility.IneligibilityType.{EntitledToWTCButNilTC, InvalidNino, NotEntitledToWTC, Unknown}
import uk.gov.hmrc.helptosavestridefrontend.models.eligibility.{EligibilityCheckResponse, IneligibilityType}
